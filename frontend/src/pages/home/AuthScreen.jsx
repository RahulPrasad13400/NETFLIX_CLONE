            ...
            <div className='flex-1'>
                <div className='relative'>
                    <img src="/stranger-things-lg.png" alt="Stranger Things" 
                        className='mt-4'
                    />
                    <div className='absolute flex items-center gap-2 bottom-5 left-1/2 -translate-x-1/2 bg-black
                    ...
                    '>
                        ...
                        <div className='flex justify-between items-center w-full'>
                            ...
                            <img src='/download-icon.gif' alt='download icon image' className='h-12' />
