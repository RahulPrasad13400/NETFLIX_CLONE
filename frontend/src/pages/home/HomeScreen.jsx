...
export default function HomeScreen() {
  ...
  return (
    ...
    <div className='relative h-screen text-white'>
      ...
      <div className='absolute top-0 left-0 w-full h-full bg-black/50 -z-50' aria-hidde="true" />

      <div className='absolute top-0 left-0 h-full w-full flex flex-col justify-center px-8
        md:px-16 lg:px-32'>
          ...
          <div className='flex mt-8'> 
            ...
            <Link to={`/watch/${trendingContent?.id}`}
              ...
              font-bold py-2 px-4 rounded mr-4 flex
							items-center'>
