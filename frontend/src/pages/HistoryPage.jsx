...
export default function HistoryPage() {
    ...
    // when there is no search history 
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3  gap-4'>
            {searchHistory.map((entry)=>{
                return <div key={entry.id} className="bg-gray-800 p-4 rounded flex items-center">
                    ...
                    <span className={`py-1 px-3 min-w-20 text-center rounded-full text-sm  ml-auto ${
						entry.searchType === "Movie" ? "bg-red-600" : entry.searchType === "tv" ? "bg-blue-600"
							: "bg-green-600" }`} >
